...
$q=substr_count($str,'а');
$w=substr_count($str,'и');
$e=substr_count($str,'е');
$r=substr_count($str,'ё');
$t=substr_count($str,'о');
$y=substr_count($str,'у');
$u=substr_count($str,'ы');
$o=substr_count($str,'э');
$p=substr_count($str,'ю');
$d=substr_count($str,'я');
